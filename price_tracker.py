"""
2modern Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from 2modern.

Docs  : https://docs.bright.cn/scraping-automation/web-scraper-api/overview
Info  : https://bright.cn/products/insights/price-tracker/2modern
"""
...
# Set your Web Scraper ID after building your 2modern scraper:
# https://bright.cn/products/web-scraper/2modern
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your 2modern scraper at: https://bright.cn/products/web-scraper/2modern\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of 2modern product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover 2modern products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a 2modern category page.

    Example:
        results = discover_by_category("https://2modern.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.2modern.com/product/sample-item-123456",
        # Add more 2modern product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "2modern_prices.json"
    ...
    # cat_results = discover_by_category("https://2modern.com/category/sample", limit=50)
